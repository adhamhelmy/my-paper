...
\begin{itemize}
  ...
  \item \textbf{Reinforcement-learning-based methods}
    \begin{itemize}
      \item \emph{PPO \cite{schulman2017proximal}:} Proximal Policy Optimisation trained directly
  ...
  \item \textbf{LLM-based methods}
    \begin{itemize}
      \item \emph{INVESTORBENCH \cite{he2024investorbench}:} a benchmark for financial
      ...
      \item \emph{FinMem \cite{yu2024finmem}:} an advanced LLM agent framework for automated
